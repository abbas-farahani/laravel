                ...
                <form action="{{ route('admin.users.update', ['user' => $user->id]) }}" method="post" class="form-horizontal">
                    ...
                    <div class="card-body">
                        <div class="form-group d-flex">
                            ...
                            <input type="text" name="name" class="form-control" id="nameinput" placeholder="نام خود را وارد کنید" value="{{ $user->name }}">

                        </div>
                        <div class="form-group d-flex">
                            <label for="emailinput" class="col-sm-1 ml-2 control-label">ایمیل</label>
                            <input type="email" name="email" class="form-control" id="emailinput" placeholder="ایمیل را وارد کنید" value="{{ $user->email }}">
